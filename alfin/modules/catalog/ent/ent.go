...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		contentassoctype.Table:           contentassoctype.ValidColumn,
		contenttype.Table:                contenttype.ValidColumn,
		costcomponenttype.Table:          costcomponenttype.ValidColumn,
		custommethod.Table:               custommethod.ValidColumn,
		custommethodtype.Table:           custommethodtype.ValidColumn,
		enumeration.Table:                enumeration.ValidColumn,
		enumerationtype.Table:            enumerationtype.ValidColumn,
		facilityassoctype.Table:          facilityassoctype.ValidColumn,
		facilitygroup.Table:              facilitygroup.ValidColumn,
		facilitygrouptype.Table:          facilitygrouptype.ValidColumn,
		facilitytype.Table:               facilitytype.ValidColumn,
		goodidentificationtype.Table:     goodidentificationtype.ValidColumn,
		inventoryitemdetail.Table:        inventoryitemdetail.ValidColumn,
		inventoryitemtype.Table:          inventoryitemtype.ValidColumn,
		orderadjustment.Table:            orderadjustment.ValidColumn,
		ordercontactmech.Table:           ordercontactmech.ValidColumn,
		orderheader.Table:                orderheader.ValidColumn,
		orderitem.Table:                  orderitem.ValidColumn,
		orderitemshipgroup.Table:         orderitemshipgroup.ValidColumn,
		orderitemshipgroupassoc.Table:    orderitemshipgroupassoc.ValidColumn,
		orderitemshipgrpinvres.Table:     orderitemshipgrpinvres.ValidColumn,
		orderpaymentpreference.Table:     orderpaymentpreference.ValidColumn,
		orderrole.Table:                  orderrole.ValidColumn,
		orderstatus.Table:                orderstatus.ValidColumn,
		prodcatalogcategorytype.Table:    prodcatalogcategorytype.ValidColumn,
		prodconfitemcontenttype.Table:    prodconfitemcontenttype.ValidColumn,
		product.Table:                    product.ValidColumn,
		productassoc.Table:               productassoc.ValidColumn,
		productassoctype.Table:           productassoctype.ValidColumn,
		productcategory.Table:            productcategory.ValidColumn,
		productcategorycontenttype.Table: productcategorycontenttype.ValidColumn,
		productcategorytype.Table:        productcategorytype.ValidColumn,
		productconfigitem.Table:          productconfigitem.ValidColumn,
		productcontenttype.Table:         productcontenttype.ValidColumn,
		productfeature.Table:             productfeature.ValidColumn,
		productfeatureappltype.Table:     productfeatureappltype.ValidColumn,
		productfeaturecategory.Table:     productfeaturecategory.ValidColumn,
		productfeatureiactntype.Table:    productfeatureiactntype.ValidColumn,
		productfeaturetype.Table:         productfeaturetype.ValidColumn,
		productmainttype.Table:           productmainttype.ValidColumn,
		productmetertype.Table:           productmetertype.ValidColumn,
		productprice.Table:               productprice.ValidColumn,
		productpriceactiontype.Table:     productpriceactiontype.ValidColumn,
		productpricepurpose.Table:        productpricepurpose.ValidColumn,
		productpricetype.Table:           productpricetype.ValidColumn,
		productreview.Table:              productreview.ValidColumn,
		productstore.Table:               productstore.ValidColumn,
		productstoregroup.Table:          productstoregroup.ValidColumn,
		producttype.Table:                producttype.ValidColumn,
		quantitybreaktype.Table:          quantitybreaktype.ValidColumn,
		rejectionreason.Table:            rejectionreason.ValidColumn,
		roletype.Table:                   roletype.ValidColumn,
		shipmentcontactmechtype.Table:    shipmentcontactmechtype.ValidColumn,
		shipmentgatewayconfig.Table:      shipmentgatewayconfig.ValidColumn,
		shipmentgatewayconfigtype.Table:  shipmentgatewayconfigtype.ValidColumn,
		shipmentgatewaydhl.Table:         shipmentgatewaydhl.ValidColumn,
		shipmentgatewayfedex.Table:       shipmentgatewayfedex.ValidColumn,
		shipmentgatewayups.Table:         shipmentgatewayups.ValidColumn,
		shipmentgatewayusps.Table:        shipmentgatewayusps.ValidColumn,
		...
		subscriptiontype.Table:           subscriptiontype.ValidColumn,
		supplierpreforder.Table:          supplierpreforder.ValidColumn,
		variancereason.Table:             variancereason.ValidColumn,
	}
