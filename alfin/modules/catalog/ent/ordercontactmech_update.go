...
func (ocmu *OrderContactMechUpdate) SetStringRef(s string) *OrderContactMechUpdate {
	ocmu.mutation.SetStringRef(s)
	return ocmu
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (ocmu *OrderContactMechUpdate) SetNillableStringRef(s *string) *OrderContactMechUpdate {
	if s != nil {
		ocmu.SetStringRef(*s)
	}
	return ocmu
...
func (ocmu *OrderContactMechUpdate) ClearStringRef() *OrderContactMechUpdate {
	ocmu.mutation.ClearStringRef()
	return ocmu
}
...
func (ocmu *OrderContactMechUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ocmu.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
	...
	if ocmu.mutation.StringRefCleared() {
...
// SetStringRef sets the "string_ref" field.
func (ocmuo *OrderContactMechUpdateOne) SetStringRef(s string) *OrderContactMechUpdateOne {
	ocmuo.mutation.SetStringRef(s)
	return ocmuo
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (ocmuo *OrderContactMechUpdateOne) SetNillableStringRef(s *string) *OrderContactMechUpdateOne {
	if s != nil {
		ocmuo.SetStringRef(*s)
	}
	return ocmuo
}

// ClearStringRef clears the value of the "string_ref" field.
func (ocmuo *OrderContactMechUpdateOne) ClearStringRef() *OrderContactMechUpdateOne {
	ocmuo.mutation.ClearStringRef()
	return ocmuo
}
...
func (ocmuo *OrderContactMechUpdateOne) sqlSave(ctx context.Context) (_node *OrderContactMech, err error) {
	...
	if value, ok := ocmuo.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: ordercontactmech.FieldStringRef,
	...
	if ocmuo.mutation.StringRefCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: ordercontactmech.FieldStringRef,
		})
