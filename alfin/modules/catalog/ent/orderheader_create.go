...
func (ohc *OrderHeaderCreate) SetStringRef(s string) *OrderHeaderCreate {
	ohc.mutation.SetStringRef(s)
	return ohc
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (ohc *OrderHeaderCreate) SetNillableStringRef(s *string) *OrderHeaderCreate {
	if s != nil {
		ohc.SetStringRef(*s)
	}
	return ohc
...
func (ohc *OrderHeaderCreate) SetSalesChannelEnumerationID(id int) *OrderHeaderCreate {
	ohc.mutation.SetSalesChannelEnumerationID(id)
	return ohc
}
...
func (ohc *OrderHeaderCreate) SetNillableSalesChannelEnumerationID(id *int) *OrderHeaderCreate {
	if id != nil {
		ohc = ohc.SetSalesChannelEnumerationID(*id)
	}
	return ohc
}

// SetSalesChannelEnumeration sets the "sales_channel_enumeration" edge to the Enumeration entity.
func (ohc *OrderHeaderCreate) SetSalesChannelEnumeration(e *Enumeration) *OrderHeaderCreate {
	return ohc.SetSalesChannelEnumerationID(e.ID)
}

// SetProductStoreID sets the "product_store" edge to the ProductStore entity by ID.
func (ohc *OrderHeaderCreate) SetProductStoreID(id int) *OrderHeaderCreate {
	ohc.mutation.SetProductStoreID(id)
	return ohc
}

// SetNillableProductStoreID sets the "product_store" edge to the ProductStore entity by ID if the given value is not nil.
func (ohc *OrderHeaderCreate) SetNillableProductStoreID(id *int) *OrderHeaderCreate {
	if id != nil {
		ohc = ohc.SetProductStoreID(*id)
	}
	return ohc
}

// SetProductStore sets the "product_store" edge to the ProductStore entity.
func (ohc *OrderHeaderCreate) SetProductStore(p *ProductStore) *OrderHeaderCreate {
	return ohc.SetProductStoreID(p.ID)
}

// SetStatusItemID sets the "status_item" edge to the StatusItem entity by ID.
func (ohc *OrderHeaderCreate) SetStatusItemID(id int) *OrderHeaderCreate {
	ohc.mutation.SetStatusItemID(id)
	return ohc
}

// SetNillableStatusItemID sets the "status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (ohc *OrderHeaderCreate) SetNillableStatusItemID(id *int) *OrderHeaderCreate {
	if id != nil {
		ohc = ohc.SetStatusItemID(*id)
	}
	return ohc
}

// SetStatusItem sets the "status_item" edge to the StatusItem entity.
func (ohc *OrderHeaderCreate) SetStatusItem(s *StatusItem) *OrderHeaderCreate {
	return ohc.SetStatusItemID(s.ID)
}

// SetSyncStatusItemID sets the "sync_status_item" edge to the StatusItem entity by ID.
func (ohc *OrderHeaderCreate) SetSyncStatusItemID(id int) *OrderHeaderCreate {
	ohc.mutation.SetSyncStatusItemID(id)
	return ohc
}

// SetNillableSyncStatusItemID sets the "sync_status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (ohc *OrderHeaderCreate) SetNillableSyncStatusItemID(id *int) *OrderHeaderCreate {
	if id != nil {
		ohc = ohc.SetSyncStatusItemID(*id)
	}
	return ohc
}

// SetSyncStatusItem sets the "sync_status_item" edge to the StatusItem entity.
func (ohc *OrderHeaderCreate) SetSyncStatusItem(s *StatusItem) *OrderHeaderCreate {
	return ohc.SetSyncStatusItemID(s.ID)
}

// AddOrderAdjustmentIDs adds the "order_adjustments" edge to the OrderAdjustment entity by IDs.
func (ohc *OrderHeaderCreate) AddOrderAdjustmentIDs(ids ...int) *OrderHeaderCreate {
	ohc.mutation.AddOrderAdjustmentIDs(ids...)
	return ohc
}

// AddOrderAdjustments adds the "order_adjustments" edges to the OrderAdjustment entity.
func (ohc *OrderHeaderCreate) AddOrderAdjustments(o ...*OrderAdjustment) *OrderHeaderCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ohc.AddOrderAdjustmentIDs(ids...)
}
...
func (ohc *OrderHeaderCreate) AddOrderItemShipGrpInvReIDs(ids ...int) *OrderHeaderCreate {
	ohc.mutation.AddOrderItemShipGrpInvReIDs(ids...)
	return ohc
}

// AddOrderItemShipGrpInvRes adds the "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (ohc *OrderHeaderCreate) AddOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderHeaderCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ohc.AddOrderItemShipGrpInvReIDs(ids...)
}

// AddOrderPaymentPreferenceIDs adds the "order_payment_preferences" edge to the OrderPaymentPreference entity by IDs.
func (ohc *OrderHeaderCreate) AddOrderPaymentPreferenceIDs(ids ...int) *OrderHeaderCreate {
	ohc.mutation.AddOrderPaymentPreferenceIDs(ids...)
	return ohc
}

// AddOrderPaymentPreferences adds the "order_payment_preferences" edges to the OrderPaymentPreference entity.
func (ohc *OrderHeaderCreate) AddOrderPaymentPreferences(o ...*OrderPaymentPreference) *OrderHeaderCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ohc.AddOrderPaymentPreferenceIDs(ids...)
}
...
func (ohc *OrderHeaderCreate) Save(ctx context.Context) (*OrderHeader, error) {
	...
	if len(ohc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			if node, err = ohc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
...
func (ohc *OrderHeaderCreate) createSpec() (*OrderHeader, *sqlgraph.CreateSpec) {
	...
	if value, ok := ohc.mutation.StringRef(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
	...
	if nodes := ohc.mutation.SalesChannelEnumerationIDs(); len(nodes) > 0 {
		...
		_node.enumeration_sales_channel_order_headers = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := ohc.mutation.ProductStoreIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
		...
		_node.product_store_order_headers = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := ohc.mutation.StatusItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
		...
		_node.status_item_order_headers = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := ohc.mutation.SyncStatusItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
		...
		_node.status_item_sync_order_headers = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := ohc.mutation.OrderAdjustmentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := ohc.mutation.OrderItemShipGrpInvResIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := ohc.mutation.OrderPaymentPreferencesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
