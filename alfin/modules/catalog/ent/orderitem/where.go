...
func StringRef(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefEQ(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStringRef), v))
	})
}
...
func StringRefNEQ(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefIn(vs ...string) predicate.OrderItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StringRefNotIn(vs ...string) predicate.OrderItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StringRefGT(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefGTE(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefLT(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefLTE(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefContains(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefHasPrefix(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefHasSuffix(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefIsNil() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefNotNil() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefEqualFold(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func StringRefContainsFold(v string) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
...
func HasStatusItem() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasStatusItemWith(preds ...predicate.StatusItem) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasStatusValidChanges applies the HasEdge predicate on the "status_valid_changes" edge.
func HasStatusValidChanges() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StatusValidChangesTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, StatusValidChangesTable, StatusValidChangesColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasStatusValidChangesWith applies the HasEdge predicate on the "status_valid_changes" edge with a given conditions (other predicates).
func HasStatusValidChangesWith(preds ...predicate.StatusValidChange) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StatusValidChangesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, StatusValidChangesTable, StatusValidChangesColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasSyncStatusItem() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSyncStatusItemWith(preds ...predicate.StatusItem) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrderAdjustments() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrderAdjustmentsWith(preds ...predicate.OrderAdjustment) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrderItemShipGrpInvRes() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrderItemShipGrpInvResWith(preds ...predicate.OrderItemShipGrpInvRes) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrderPaymentPreferences() predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasOrderPaymentPreferencesWith(preds ...predicate.OrderPaymentPreference) predicate.OrderItem {
	return predicate.OrderItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
