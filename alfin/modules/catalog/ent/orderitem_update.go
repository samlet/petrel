...
func (oiu *OrderItemUpdate) SetStringRef(s string) *OrderItemUpdate {
	oiu.mutation.SetStringRef(s)
	return oiu
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oiu *OrderItemUpdate) SetNillableStringRef(s *string) *OrderItemUpdate {
	if s != nil {
		oiu.SetStringRef(*s)
	}
	return oiu
...
func (oiu *OrderItemUpdate) ClearStringRef() *OrderItemUpdate {
	oiu.mutation.ClearStringRef()
	return oiu
}
...
func (oiu *OrderItemUpdate) SetStatusItemID(id int) *OrderItemUpdate {
	oiu.mutation.SetStatusItemID(id)
	return oiu
}

// SetNillableStatusItemID sets the "status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (oiu *OrderItemUpdate) SetNillableStatusItemID(id *int) *OrderItemUpdate {
	if id != nil {
		oiu = oiu.SetStatusItemID(*id)
	}
	return oiu
}

// SetStatusItem sets the "status_item" edge to the StatusItem entity.
func (oiu *OrderItemUpdate) SetStatusItem(s *StatusItem) *OrderItemUpdate {
	return oiu.SetStatusItemID(s.ID)
}

// AddStatusValidChangeIDs adds the "status_valid_changes" edge to the StatusValidChange entity by IDs.
func (oiu *OrderItemUpdate) AddStatusValidChangeIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.AddStatusValidChangeIDs(ids...)
	return oiu
}

// AddStatusValidChanges adds the "status_valid_changes" edges to the StatusValidChange entity.
func (oiu *OrderItemUpdate) AddStatusValidChanges(s ...*StatusValidChange) *OrderItemUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return oiu.AddStatusValidChangeIDs(ids...)
}

// SetSyncStatusItemID sets the "sync_status_item" edge to the StatusItem entity by ID.
func (oiu *OrderItemUpdate) SetSyncStatusItemID(id int) *OrderItemUpdate {
	oiu.mutation.SetSyncStatusItemID(id)
	return oiu
}

// SetNillableSyncStatusItemID sets the "sync_status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (oiu *OrderItemUpdate) SetNillableSyncStatusItemID(id *int) *OrderItemUpdate {
	if id != nil {
		oiu = oiu.SetSyncStatusItemID(*id)
	}
	return oiu
}

// SetSyncStatusItem sets the "sync_status_item" edge to the StatusItem entity.
func (oiu *OrderItemUpdate) SetSyncStatusItem(s *StatusItem) *OrderItemUpdate {
	return oiu.SetSyncStatusItemID(s.ID)
}

// AddOrderAdjustmentIDs adds the "order_adjustments" edge to the OrderAdjustment entity by IDs.
func (oiu *OrderItemUpdate) AddOrderAdjustmentIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.AddOrderAdjustmentIDs(ids...)
	return oiu
}

// AddOrderAdjustments adds the "order_adjustments" edges to the OrderAdjustment entity.
func (oiu *OrderItemUpdate) AddOrderAdjustments(o ...*OrderAdjustment) *OrderItemUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiu.AddOrderAdjustmentIDs(ids...)
}
...
func (oiu *OrderItemUpdate) AddOrderItemShipGrpInvReIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.AddOrderItemShipGrpInvReIDs(ids...)
	return oiu
}

// AddOrderItemShipGrpInvRes adds the "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oiu *OrderItemUpdate) AddOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiu.AddOrderItemShipGrpInvReIDs(ids...)
}

// AddOrderPaymentPreferenceIDs adds the "order_payment_preferences" edge to the OrderPaymentPreference entity by IDs.
func (oiu *OrderItemUpdate) AddOrderPaymentPreferenceIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.AddOrderPaymentPreferenceIDs(ids...)
	return oiu
}

// AddOrderPaymentPreferences adds the "order_payment_preferences" edges to the OrderPaymentPreference entity.
func (oiu *OrderItemUpdate) AddOrderPaymentPreferences(o ...*OrderPaymentPreference) *OrderItemUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiu.AddOrderPaymentPreferenceIDs(ids...)
}
...
func (oiu *OrderItemUpdate) ClearStatusItem() *OrderItemUpdate {
	oiu.mutation.ClearStatusItem()
	return oiu
}

// ClearStatusValidChanges clears all "status_valid_changes" edges to the StatusValidChange entity.
func (oiu *OrderItemUpdate) ClearStatusValidChanges() *OrderItemUpdate {
	oiu.mutation.ClearStatusValidChanges()
	return oiu
}

// RemoveStatusValidChangeIDs removes the "status_valid_changes" edge to StatusValidChange entities by IDs.
func (oiu *OrderItemUpdate) RemoveStatusValidChangeIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.RemoveStatusValidChangeIDs(ids...)
	return oiu
}

// RemoveStatusValidChanges removes "status_valid_changes" edges to StatusValidChange entities.
func (oiu *OrderItemUpdate) RemoveStatusValidChanges(s ...*StatusValidChange) *OrderItemUpdate {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return oiu.RemoveStatusValidChangeIDs(ids...)
}

// ClearSyncStatusItem clears the "sync_status_item" edge to the StatusItem entity.
func (oiu *OrderItemUpdate) ClearSyncStatusItem() *OrderItemUpdate {
	oiu.mutation.ClearSyncStatusItem()
	return oiu
}

// ClearOrderAdjustments clears all "order_adjustments" edges to the OrderAdjustment entity.
func (oiu *OrderItemUpdate) ClearOrderAdjustments() *OrderItemUpdate {
	oiu.mutation.ClearOrderAdjustments()
	return oiu
}

// RemoveOrderAdjustmentIDs removes the "order_adjustments" edge to OrderAdjustment entities by IDs.
func (oiu *OrderItemUpdate) RemoveOrderAdjustmentIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.RemoveOrderAdjustmentIDs(ids...)
	return oiu
}

// RemoveOrderAdjustments removes "order_adjustments" edges to OrderAdjustment entities.
func (oiu *OrderItemUpdate) RemoveOrderAdjustments(o ...*OrderAdjustment) *OrderItemUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiu.RemoveOrderAdjustmentIDs(ids...)
}
...
func (oiu *OrderItemUpdate) ClearOrderItemShipGrpInvRes() *OrderItemUpdate {
	oiu.mutation.ClearOrderItemShipGrpInvRes()
	return oiu
}

// RemoveOrderItemShipGrpInvReIDs removes the "order_item_ship_grp_inv_res" edge to OrderItemShipGrpInvRes entities by IDs.
func (oiu *OrderItemUpdate) RemoveOrderItemShipGrpInvReIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.RemoveOrderItemShipGrpInvReIDs(ids...)
	return oiu
}

// RemoveOrderItemShipGrpInvRes removes "order_item_ship_grp_inv_res" edges to OrderItemShipGrpInvRes entities.
func (oiu *OrderItemUpdate) RemoveOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiu.RemoveOrderItemShipGrpInvReIDs(ids...)
}

// ClearOrderPaymentPreferences clears all "order_payment_preferences" edges to the OrderPaymentPreference entity.
func (oiu *OrderItemUpdate) ClearOrderPaymentPreferences() *OrderItemUpdate {
	oiu.mutation.ClearOrderPaymentPreferences()
	return oiu
}

// RemoveOrderPaymentPreferenceIDs removes the "order_payment_preferences" edge to OrderPaymentPreference entities by IDs.
func (oiu *OrderItemUpdate) RemoveOrderPaymentPreferenceIDs(ids ...int) *OrderItemUpdate {
	oiu.mutation.RemoveOrderPaymentPreferenceIDs(ids...)
	return oiu
}

// RemoveOrderPaymentPreferences removes "order_payment_preferences" edges to OrderPaymentPreference entities.
func (oiu *OrderItemUpdate) RemoveOrderPaymentPreferences(o ...*OrderPaymentPreference) *OrderItemUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiu.RemoveOrderPaymentPreferenceIDs(ids...)
}
...
func (oiu *OrderItemUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := oiu.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
	...
	if oiu.mutation.StringRefCleared() {
	...
	if oiu.mutation.StatusItemCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
	...
	if nodes := oiu.mutation.StatusItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderitem.StatusItemTable,
	...
	if oiu.mutation.StatusValidChangesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oiu.mutation.RemovedStatusValidChangesIDs(); len(nodes) > 0 && !oiu.mutation.StatusValidChangesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.StatusValidChangesTable,
	...
	if nodes := oiu.mutation.StatusValidChangesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.StatusValidChangesTable,
	...
	if oiu.mutation.SyncStatusItemCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
	...
	if nodes := oiu.mutation.SyncStatusItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderitem.SyncStatusItemTable,
	...
	if oiu.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oiu.mutation.RemovedOrderAdjustmentsIDs(); len(nodes) > 0 && !oiu.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderAdjustmentsTable,
	...
	if nodes := oiu.mutation.OrderAdjustmentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderAdjustmentsTable,
	...
	if oiu.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oiu.mutation.RemovedOrderItemShipGrpInvResIDs(); len(nodes) > 0 && !oiu.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderItemShipGrpInvResTable,
	...
	if nodes := oiu.mutation.OrderItemShipGrpInvResIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderItemShipGrpInvResTable,
	...
	if oiu.mutation.OrderPaymentPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oiu.mutation.RemovedOrderPaymentPreferencesIDs(); len(nodes) > 0 && !oiu.mutation.OrderPaymentPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderPaymentPreferencesTable,
	...
	if nodes := oiu.mutation.OrderPaymentPreferencesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderPaymentPreferencesTable,
...
// SetStringRef sets the "string_ref" field.
func (oiuo *OrderItemUpdateOne) SetStringRef(s string) *OrderItemUpdateOne {
	oiuo.mutation.SetStringRef(s)
	return oiuo
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oiuo *OrderItemUpdateOne) SetNillableStringRef(s *string) *OrderItemUpdateOne {
	if s != nil {
		oiuo.SetStringRef(*s)
	}
	return oiuo
...
// ClearStringRef clears the value of the "string_ref" field.
func (oiuo *OrderItemUpdateOne) ClearStringRef() *OrderItemUpdateOne {
	oiuo.mutation.ClearStringRef()
	return oiuo
}
...
// SetStatusItemID sets the "status_item" edge to the StatusItem entity by ID.
func (oiuo *OrderItemUpdateOne) SetStatusItemID(id int) *OrderItemUpdateOne {
	oiuo.mutation.SetStatusItemID(id)
	return oiuo
}

// SetNillableStatusItemID sets the "status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (oiuo *OrderItemUpdateOne) SetNillableStatusItemID(id *int) *OrderItemUpdateOne {
	if id != nil {
		oiuo = oiuo.SetStatusItemID(*id)
	}
	return oiuo
}

// SetStatusItem sets the "status_item" edge to the StatusItem entity.
func (oiuo *OrderItemUpdateOne) SetStatusItem(s *StatusItem) *OrderItemUpdateOne {
	return oiuo.SetStatusItemID(s.ID)
}

// AddStatusValidChangeIDs adds the "status_valid_changes" edge to the StatusValidChange entity by IDs.
func (oiuo *OrderItemUpdateOne) AddStatusValidChangeIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.AddStatusValidChangeIDs(ids...)
	return oiuo
}

// AddStatusValidChanges adds the "status_valid_changes" edges to the StatusValidChange entity.
func (oiuo *OrderItemUpdateOne) AddStatusValidChanges(s ...*StatusValidChange) *OrderItemUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return oiuo.AddStatusValidChangeIDs(ids...)
}

// SetSyncStatusItemID sets the "sync_status_item" edge to the StatusItem entity by ID.
func (oiuo *OrderItemUpdateOne) SetSyncStatusItemID(id int) *OrderItemUpdateOne {
	oiuo.mutation.SetSyncStatusItemID(id)
	return oiuo
}

// SetNillableSyncStatusItemID sets the "sync_status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (oiuo *OrderItemUpdateOne) SetNillableSyncStatusItemID(id *int) *OrderItemUpdateOne {
	if id != nil {
		oiuo = oiuo.SetSyncStatusItemID(*id)
	}
	return oiuo
}

// SetSyncStatusItem sets the "sync_status_item" edge to the StatusItem entity.
func (oiuo *OrderItemUpdateOne) SetSyncStatusItem(s *StatusItem) *OrderItemUpdateOne {
	return oiuo.SetSyncStatusItemID(s.ID)
}

// AddOrderAdjustmentIDs adds the "order_adjustments" edge to the OrderAdjustment entity by IDs.
func (oiuo *OrderItemUpdateOne) AddOrderAdjustmentIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.AddOrderAdjustmentIDs(ids...)
	return oiuo
}

// AddOrderAdjustments adds the "order_adjustments" edges to the OrderAdjustment entity.
func (oiuo *OrderItemUpdateOne) AddOrderAdjustments(o ...*OrderAdjustment) *OrderItemUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiuo.AddOrderAdjustmentIDs(ids...)
}
...
// AddOrderItemShipGrpInvReIDs adds the "order_item_ship_grp_inv_res" edge to the OrderItemShipGrpInvRes entity by IDs.
func (oiuo *OrderItemUpdateOne) AddOrderItemShipGrpInvReIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.AddOrderItemShipGrpInvReIDs(ids...)
	return oiuo
}

// AddOrderItemShipGrpInvRes adds the "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oiuo *OrderItemUpdateOne) AddOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiuo.AddOrderItemShipGrpInvReIDs(ids...)
}

// AddOrderPaymentPreferenceIDs adds the "order_payment_preferences" edge to the OrderPaymentPreference entity by IDs.
func (oiuo *OrderItemUpdateOne) AddOrderPaymentPreferenceIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.AddOrderPaymentPreferenceIDs(ids...)
	return oiuo
}

// AddOrderPaymentPreferences adds the "order_payment_preferences" edges to the OrderPaymentPreference entity.
func (oiuo *OrderItemUpdateOne) AddOrderPaymentPreferences(o ...*OrderPaymentPreference) *OrderItemUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiuo.AddOrderPaymentPreferenceIDs(ids...)
}
...
// ClearStatusItem clears the "status_item" edge to the StatusItem entity.
func (oiuo *OrderItemUpdateOne) ClearStatusItem() *OrderItemUpdateOne {
	oiuo.mutation.ClearStatusItem()
	return oiuo
}

// ClearStatusValidChanges clears all "status_valid_changes" edges to the StatusValidChange entity.
func (oiuo *OrderItemUpdateOne) ClearStatusValidChanges() *OrderItemUpdateOne {
	oiuo.mutation.ClearStatusValidChanges()
	return oiuo
}

// RemoveStatusValidChangeIDs removes the "status_valid_changes" edge to StatusValidChange entities by IDs.
func (oiuo *OrderItemUpdateOne) RemoveStatusValidChangeIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.RemoveStatusValidChangeIDs(ids...)
	return oiuo
}

// RemoveStatusValidChanges removes "status_valid_changes" edges to StatusValidChange entities.
func (oiuo *OrderItemUpdateOne) RemoveStatusValidChanges(s ...*StatusValidChange) *OrderItemUpdateOne {
	ids := make([]int, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return oiuo.RemoveStatusValidChangeIDs(ids...)
}

// ClearSyncStatusItem clears the "sync_status_item" edge to the StatusItem entity.
func (oiuo *OrderItemUpdateOne) ClearSyncStatusItem() *OrderItemUpdateOne {
	oiuo.mutation.ClearSyncStatusItem()
	return oiuo
}

// ClearOrderAdjustments clears all "order_adjustments" edges to the OrderAdjustment entity.
func (oiuo *OrderItemUpdateOne) ClearOrderAdjustments() *OrderItemUpdateOne {
	oiuo.mutation.ClearOrderAdjustments()
	return oiuo
}

// RemoveOrderAdjustmentIDs removes the "order_adjustments" edge to OrderAdjustment entities by IDs.
func (oiuo *OrderItemUpdateOne) RemoveOrderAdjustmentIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.RemoveOrderAdjustmentIDs(ids...)
	return oiuo
}

// RemoveOrderAdjustments removes "order_adjustments" edges to OrderAdjustment entities.
func (oiuo *OrderItemUpdateOne) RemoveOrderAdjustments(o ...*OrderAdjustment) *OrderItemUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiuo.RemoveOrderAdjustmentIDs(ids...)
}
...
// ClearOrderItemShipGrpInvRes clears all "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oiuo *OrderItemUpdateOne) ClearOrderItemShipGrpInvRes() *OrderItemUpdateOne {
	oiuo.mutation.ClearOrderItemShipGrpInvRes()
	return oiuo
}

// RemoveOrderItemShipGrpInvReIDs removes the "order_item_ship_grp_inv_res" edge to OrderItemShipGrpInvRes entities by IDs.
func (oiuo *OrderItemUpdateOne) RemoveOrderItemShipGrpInvReIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.RemoveOrderItemShipGrpInvReIDs(ids...)
	return oiuo
}

// RemoveOrderItemShipGrpInvRes removes "order_item_ship_grp_inv_res" edges to OrderItemShipGrpInvRes entities.
func (oiuo *OrderItemUpdateOne) RemoveOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiuo.RemoveOrderItemShipGrpInvReIDs(ids...)
}

// ClearOrderPaymentPreferences clears all "order_payment_preferences" edges to the OrderPaymentPreference entity.
func (oiuo *OrderItemUpdateOne) ClearOrderPaymentPreferences() *OrderItemUpdateOne {
	oiuo.mutation.ClearOrderPaymentPreferences()
	return oiuo
}

// RemoveOrderPaymentPreferenceIDs removes the "order_payment_preferences" edge to OrderPaymentPreference entities by IDs.
func (oiuo *OrderItemUpdateOne) RemoveOrderPaymentPreferenceIDs(ids ...int) *OrderItemUpdateOne {
	oiuo.mutation.RemoveOrderPaymentPreferenceIDs(ids...)
	return oiuo
}

// RemoveOrderPaymentPreferences removes "order_payment_preferences" edges to OrderPaymentPreference entities.
func (oiuo *OrderItemUpdateOne) RemoveOrderPaymentPreferences(o ...*OrderPaymentPreference) *OrderItemUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oiuo.RemoveOrderPaymentPreferenceIDs(ids...)
}
...
func (oiuo *OrderItemUpdateOne) sqlSave(ctx context.Context) (_node *OrderItem, err error) {
	...
	if value, ok := oiuo.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: orderitem.FieldStringRef,
	...
	if oiuo.mutation.StringRefCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: orderitem.FieldStringRef,
		})
	...
	if oiuo.mutation.StatusItemCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderitem.StatusItemTable,
	...
	if nodes := oiuo.mutation.StatusItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderitem.StatusItemTable,
	...
	if oiuo.mutation.StatusValidChangesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.StatusValidChangesTable,
	...
	if nodes := oiuo.mutation.RemovedStatusValidChangesIDs(); len(nodes) > 0 && !oiuo.mutation.StatusValidChangesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.StatusValidChangesTable,
	...
	if nodes := oiuo.mutation.StatusValidChangesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.StatusValidChangesTable,
	...
	if oiuo.mutation.SyncStatusItemCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderitem.SyncStatusItemTable,
	...
	if nodes := oiuo.mutation.SyncStatusItemIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderitem.SyncStatusItemTable,
	...
	if oiuo.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderAdjustmentsTable,
	...
	if nodes := oiuo.mutation.RemovedOrderAdjustmentsIDs(); len(nodes) > 0 && !oiuo.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderAdjustmentsTable,
	...
	if nodes := oiuo.mutation.OrderAdjustmentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderAdjustmentsTable,
	...
	if oiuo.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderItemShipGrpInvResTable,
	...
	if nodes := oiuo.mutation.RemovedOrderItemShipGrpInvResIDs(); len(nodes) > 0 && !oiuo.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderItemShipGrpInvResTable,
	...
	if nodes := oiuo.mutation.OrderItemShipGrpInvResIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderItemShipGrpInvResTable,
	...
	if oiuo.mutation.OrderPaymentPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderPaymentPreferencesTable,
	...
	if nodes := oiuo.mutation.RemovedOrderPaymentPreferencesIDs(); len(nodes) > 0 && !oiuo.mutation.OrderPaymentPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderPaymentPreferencesTable,
	...
	if nodes := oiuo.mutation.OrderPaymentPreferencesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitem.OrderPaymentPreferencesTable,
