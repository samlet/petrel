...
const (
	...
	OrderAdjustmentsColumn = "order_item_ship_group_order_adjustments"
	...
	OrderItemShipGrpInvResColumn = "order_item_ship_group_order_item_ship_grp_inv_res"
	...
	OrderPaymentPreferencesColumn = "order_item_ship_group_order_payment_preferences"
)
...
// MaySplit values.
const (
	MaySplitYes     MaySplit = "Yes"
	MaySplitNo      MaySplit = "No"
	MaySplitUnknown MaySplit = "Unknown"
)
...
func MaySplitValidator(ms MaySplit) error {
	switch ms {
	case MaySplitYes, MaySplitNo, MaySplitUnknown:
		return nil
	default:
...
// IsGift values.
const (
	IsGiftYes     IsGift = "Yes"
	IsGiftNo      IsGift = "No"
	IsGiftUnknown IsGift = "Unknown"
)
...
func IsGiftValidator(ig IsGift) error {
	switch ig {
	case IsGiftYes, IsGiftNo, IsGiftUnknown:
		return nil
	default:
