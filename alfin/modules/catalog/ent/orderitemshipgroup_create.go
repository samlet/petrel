...
func (oisgc *OrderItemShipGroupCreate) SetStringRef(s string) *OrderItemShipGroupCreate {
	oisgc.mutation.SetStringRef(s)
	return oisgc
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oisgc *OrderItemShipGroupCreate) SetNillableStringRef(s *string) *OrderItemShipGroupCreate {
	if s != nil {
		oisgc.SetStringRef(*s)
	}
	return oisgc
}
...
func (oisgc *OrderItemShipGroupCreate) AddOrderAdjustmentIDs(ids ...int) *OrderItemShipGroupCreate {
	oisgc.mutation.AddOrderAdjustmentIDs(ids...)
	return oisgc
}

// AddOrderAdjustments adds the "order_adjustments" edges to the OrderAdjustment entity.
func (oisgc *OrderItemShipGroupCreate) AddOrderAdjustments(o ...*OrderAdjustment) *OrderItemShipGroupCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgc.AddOrderAdjustmentIDs(ids...)
}
...
func (oisgc *OrderItemShipGroupCreate) AddOrderItemShipGrpInvReIDs(ids ...int) *OrderItemShipGroupCreate {
	oisgc.mutation.AddOrderItemShipGrpInvReIDs(ids...)
	return oisgc
}

// AddOrderItemShipGrpInvRes adds the "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oisgc *OrderItemShipGroupCreate) AddOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemShipGroupCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgc.AddOrderItemShipGrpInvReIDs(ids...)
}

// AddOrderPaymentPreferenceIDs adds the "order_payment_preferences" edge to the OrderPaymentPreference entity by IDs.
func (oisgc *OrderItemShipGroupCreate) AddOrderPaymentPreferenceIDs(ids ...int) *OrderItemShipGroupCreate {
	oisgc.mutation.AddOrderPaymentPreferenceIDs(ids...)
	return oisgc
}

// AddOrderPaymentPreferences adds the "order_payment_preferences" edges to the OrderPaymentPreference entity.
func (oisgc *OrderItemShipGroupCreate) AddOrderPaymentPreferences(o ...*OrderPaymentPreference) *OrderItemShipGroupCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgc.AddOrderPaymentPreferenceIDs(ids...)
}
...
func (oisgc *OrderItemShipGroupCreate) Save(ctx context.Context) (*OrderItemShipGroup, error) {
	...
	if len(oisgc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			if node, err = oisgc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
...
func (oisgc *OrderItemShipGroupCreate) createSpec() (*OrderItemShipGroup, *sqlgraph.CreateSpec) {
	...
	if value, ok := oisgc.mutation.StringRef(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
	...
	if nodes := oisgc.mutation.OrderAdjustmentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oisgc.mutation.OrderItemShipGrpInvResIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oisgc.mutation.OrderPaymentPreferencesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
