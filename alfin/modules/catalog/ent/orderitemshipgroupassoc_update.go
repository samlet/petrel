...
func (oisgau *OrderItemShipGroupAssocUpdate) SetStringRef(s string) *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.SetStringRef(s)
	return oisgau
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oisgau *OrderItemShipGroupAssocUpdate) SetNillableStringRef(s *string) *OrderItemShipGroupAssocUpdate {
	if s != nil {
		oisgau.SetStringRef(*s)
	}
	return oisgau
}

// ClearStringRef clears the value of the "string_ref" field.
func (oisgau *OrderItemShipGroupAssocUpdate) ClearStringRef() *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.ClearStringRef()
	return oisgau
}
...
func (oisgau *OrderItemShipGroupAssocUpdate) AddOrderAdjustmentIDs(ids ...int) *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.AddOrderAdjustmentIDs(ids...)
	return oisgau
}

// AddOrderAdjustments adds the "order_adjustments" edges to the OrderAdjustment entity.
func (oisgau *OrderItemShipGroupAssocUpdate) AddOrderAdjustments(o ...*OrderAdjustment) *OrderItemShipGroupAssocUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgau.AddOrderAdjustmentIDs(ids...)
}

// AddOrderItemShipGrpInvReIDs adds the "order_item_ship_grp_inv_res" edge to the OrderItemShipGrpInvRes entity by IDs.
func (oisgau *OrderItemShipGroupAssocUpdate) AddOrderItemShipGrpInvReIDs(ids ...int) *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.AddOrderItemShipGrpInvReIDs(ids...)
	return oisgau
}

// AddOrderItemShipGrpInvRes adds the "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oisgau *OrderItemShipGroupAssocUpdate) AddOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemShipGroupAssocUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgau.AddOrderItemShipGrpInvReIDs(ids...)
}
...
func (oisgau *OrderItemShipGroupAssocUpdate) ClearOrderAdjustments() *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.ClearOrderAdjustments()
	return oisgau
}

// RemoveOrderAdjustmentIDs removes the "order_adjustments" edge to OrderAdjustment entities by IDs.
func (oisgau *OrderItemShipGroupAssocUpdate) RemoveOrderAdjustmentIDs(ids ...int) *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.RemoveOrderAdjustmentIDs(ids...)
	return oisgau
}

// RemoveOrderAdjustments removes "order_adjustments" edges to OrderAdjustment entities.
func (oisgau *OrderItemShipGroupAssocUpdate) RemoveOrderAdjustments(o ...*OrderAdjustment) *OrderItemShipGroupAssocUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgau.RemoveOrderAdjustmentIDs(ids...)
}

// ClearOrderItemShipGrpInvRes clears all "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oisgau *OrderItemShipGroupAssocUpdate) ClearOrderItemShipGrpInvRes() *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.ClearOrderItemShipGrpInvRes()
	return oisgau
}

// RemoveOrderItemShipGrpInvReIDs removes the "order_item_ship_grp_inv_res" edge to OrderItemShipGrpInvRes entities by IDs.
func (oisgau *OrderItemShipGroupAssocUpdate) RemoveOrderItemShipGrpInvReIDs(ids ...int) *OrderItemShipGroupAssocUpdate {
	oisgau.mutation.RemoveOrderItemShipGrpInvReIDs(ids...)
	return oisgau
}

// RemoveOrderItemShipGrpInvRes removes "order_item_ship_grp_inv_res" edges to OrderItemShipGrpInvRes entities.
func (oisgau *OrderItemShipGroupAssocUpdate) RemoveOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemShipGroupAssocUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgau.RemoveOrderItemShipGrpInvReIDs(ids...)
}
...
func (oisgau *OrderItemShipGroupAssocUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := oisgau.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
	...
	if oisgau.mutation.StringRefCleared() {
	...
	if oisgau.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oisgau.mutation.RemovedOrderAdjustmentsIDs(); len(nodes) > 0 && !oisgau.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderAdjustmentsTable,
	...
	if nodes := oisgau.mutation.OrderAdjustmentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderAdjustmentsTable,
	...
	if oisgau.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oisgau.mutation.RemovedOrderItemShipGrpInvResIDs(); len(nodes) > 0 && !oisgau.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderItemShipGrpInvResTable,
	...
	if nodes := oisgau.mutation.OrderItemShipGrpInvResIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderItemShipGrpInvResTable,
...
// SetStringRef sets the "string_ref" field.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) SetStringRef(s string) *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.SetStringRef(s)
	return oisgauo
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) SetNillableStringRef(s *string) *OrderItemShipGroupAssocUpdateOne {
	if s != nil {
		oisgauo.SetStringRef(*s)
	}
	return oisgauo
}

// ClearStringRef clears the value of the "string_ref" field.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) ClearStringRef() *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.ClearStringRef()
	return oisgauo
}
...
// AddOrderAdjustmentIDs adds the "order_adjustments" edge to the OrderAdjustment entity by IDs.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) AddOrderAdjustmentIDs(ids ...int) *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.AddOrderAdjustmentIDs(ids...)
	return oisgauo
}

// AddOrderAdjustments adds the "order_adjustments" edges to the OrderAdjustment entity.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) AddOrderAdjustments(o ...*OrderAdjustment) *OrderItemShipGroupAssocUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgauo.AddOrderAdjustmentIDs(ids...)
}

// AddOrderItemShipGrpInvReIDs adds the "order_item_ship_grp_inv_res" edge to the OrderItemShipGrpInvRes entity by IDs.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) AddOrderItemShipGrpInvReIDs(ids ...int) *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.AddOrderItemShipGrpInvReIDs(ids...)
	return oisgauo
}

// AddOrderItemShipGrpInvRes adds the "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) AddOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemShipGroupAssocUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgauo.AddOrderItemShipGrpInvReIDs(ids...)
}
...
// ClearOrderAdjustments clears all "order_adjustments" edges to the OrderAdjustment entity.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) ClearOrderAdjustments() *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.ClearOrderAdjustments()
	return oisgauo
}

// RemoveOrderAdjustmentIDs removes the "order_adjustments" edge to OrderAdjustment entities by IDs.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) RemoveOrderAdjustmentIDs(ids ...int) *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.RemoveOrderAdjustmentIDs(ids...)
	return oisgauo
}

// RemoveOrderAdjustments removes "order_adjustments" edges to OrderAdjustment entities.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) RemoveOrderAdjustments(o ...*OrderAdjustment) *OrderItemShipGroupAssocUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgauo.RemoveOrderAdjustmentIDs(ids...)
}

// ClearOrderItemShipGrpInvRes clears all "order_item_ship_grp_inv_res" edges to the OrderItemShipGrpInvRes entity.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) ClearOrderItemShipGrpInvRes() *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.ClearOrderItemShipGrpInvRes()
	return oisgauo
}

// RemoveOrderItemShipGrpInvReIDs removes the "order_item_ship_grp_inv_res" edge to OrderItemShipGrpInvRes entities by IDs.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) RemoveOrderItemShipGrpInvReIDs(ids ...int) *OrderItemShipGroupAssocUpdateOne {
	oisgauo.mutation.RemoveOrderItemShipGrpInvReIDs(ids...)
	return oisgauo
}

// RemoveOrderItemShipGrpInvRes removes "order_item_ship_grp_inv_res" edges to OrderItemShipGrpInvRes entities.
func (oisgauo *OrderItemShipGroupAssocUpdateOne) RemoveOrderItemShipGrpInvRes(o ...*OrderItemShipGrpInvRes) *OrderItemShipGroupAssocUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oisgauo.RemoveOrderItemShipGrpInvReIDs(ids...)
}
...
func (oisgauo *OrderItemShipGroupAssocUpdateOne) sqlSave(ctx context.Context) (_node *OrderItemShipGroupAssoc, err error) {
	...
	if value, ok := oisgauo.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: orderitemshipgroupassoc.FieldStringRef,
	...
	if oisgauo.mutation.StringRefCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: orderitemshipgroupassoc.FieldStringRef,
		})
	...
	if oisgauo.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderAdjustmentsTable,
	...
	if nodes := oisgauo.mutation.RemovedOrderAdjustmentsIDs(); len(nodes) > 0 && !oisgauo.mutation.OrderAdjustmentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderAdjustmentsTable,
	...
	if nodes := oisgauo.mutation.OrderAdjustmentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderAdjustmentsTable,
	...
	if oisgauo.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderItemShipGrpInvResTable,
	...
	if nodes := oisgauo.mutation.RemovedOrderItemShipGrpInvResIDs(); len(nodes) > 0 && !oisgauo.mutation.OrderItemShipGrpInvResCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderItemShipGrpInvResTable,
	...
	if nodes := oisgauo.mutation.OrderItemShipGrpInvResIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   orderitemshipgroupassoc.OrderItemShipGrpInvResTable,
