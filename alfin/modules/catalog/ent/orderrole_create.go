...
func (orc *OrderRoleCreate) SetStringRef(s string) *OrderRoleCreate {
	orc.mutation.SetStringRef(s)
	return orc
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (orc *OrderRoleCreate) SetNillableStringRef(s *string) *OrderRoleCreate {
	if s != nil {
		orc.SetStringRef(*s)
	}
	return orc
...
func (orc *OrderRoleCreate) SetRoleTypeID(id int) *OrderRoleCreate {
	orc.mutation.SetRoleTypeID(id)
	return orc
}

// SetNillableRoleTypeID sets the "role_type" edge to the RoleType entity by ID if the given value is not nil.
func (orc *OrderRoleCreate) SetNillableRoleTypeID(id *int) *OrderRoleCreate {
	if id != nil {
		orc = orc.SetRoleTypeID(*id)
	}
	return orc
}

// SetRoleType sets the "role_type" edge to the RoleType entity.
func (orc *OrderRoleCreate) SetRoleType(r *RoleType) *OrderRoleCreate {
	return orc.SetRoleTypeID(r.ID)
}
...
func (orc *OrderRoleCreate) createSpec() (*OrderRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := orc.mutation.StringRef(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
	...
	if nodes := orc.mutation.RoleTypeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
		...
		_node.role_type_order_roles = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
