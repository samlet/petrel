...
func (oru *OrderRoleUpdate) SetStringRef(s string) *OrderRoleUpdate {
	oru.mutation.SetStringRef(s)
	return oru
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oru *OrderRoleUpdate) SetNillableStringRef(s *string) *OrderRoleUpdate {
	if s != nil {
		oru.SetStringRef(*s)
	}
	return oru
...
func (oru *OrderRoleUpdate) ClearStringRef() *OrderRoleUpdate {
	oru.mutation.ClearStringRef()
	return oru
}
...
func (oru *OrderRoleUpdate) SetRoleTypeID(id int) *OrderRoleUpdate {
	oru.mutation.SetRoleTypeID(id)
	return oru
}

// SetNillableRoleTypeID sets the "role_type" edge to the RoleType entity by ID if the given value is not nil.
func (oru *OrderRoleUpdate) SetNillableRoleTypeID(id *int) *OrderRoleUpdate {
	if id != nil {
		oru = oru.SetRoleTypeID(*id)
	}
	return oru
}

// SetRoleType sets the "role_type" edge to the RoleType entity.
func (oru *OrderRoleUpdate) SetRoleType(r *RoleType) *OrderRoleUpdate {
	return oru.SetRoleTypeID(r.ID)
}
...
func (oru *OrderRoleUpdate) ClearRoleType() *OrderRoleUpdate {
	oru.mutation.ClearRoleType()
	return oru
}
...
func (oru *OrderRoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := oru.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: orderrole.FieldStringRef,
		})
	}
	if oru.mutation.StringRefCleared() {
	...
	if oru.mutation.RoleTypeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderrole.RoleTypeTable,
			Columns: []string{orderrole.RoleTypeColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: &sqlgraph.FieldSpec{
					Type:   field.TypeInt,
	...
	if nodes := oru.mutation.RoleTypeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderrole.RoleTypeTable,
...
// SetStringRef sets the "string_ref" field.
func (oruo *OrderRoleUpdateOne) SetStringRef(s string) *OrderRoleUpdateOne {
	oruo.mutation.SetStringRef(s)
	return oruo
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (oruo *OrderRoleUpdateOne) SetNillableStringRef(s *string) *OrderRoleUpdateOne {
	if s != nil {
		oruo.SetStringRef(*s)
	}
	return oruo
...
// ClearStringRef clears the value of the "string_ref" field.
func (oruo *OrderRoleUpdateOne) ClearStringRef() *OrderRoleUpdateOne {
	oruo.mutation.ClearStringRef()
	return oruo
}
...
// SetRoleTypeID sets the "role_type" edge to the RoleType entity by ID.
func (oruo *OrderRoleUpdateOne) SetRoleTypeID(id int) *OrderRoleUpdateOne {
	oruo.mutation.SetRoleTypeID(id)
	return oruo
}

// SetNillableRoleTypeID sets the "role_type" edge to the RoleType entity by ID if the given value is not nil.
func (oruo *OrderRoleUpdateOne) SetNillableRoleTypeID(id *int) *OrderRoleUpdateOne {
	if id != nil {
		oruo = oruo.SetRoleTypeID(*id)
	}
	return oruo
}

// SetRoleType sets the "role_type" edge to the RoleType entity.
func (oruo *OrderRoleUpdateOne) SetRoleType(r *RoleType) *OrderRoleUpdateOne {
	return oruo.SetRoleTypeID(r.ID)
}
...
// ClearRoleType clears the "role_type" edge to the RoleType entity.
func (oruo *OrderRoleUpdateOne) ClearRoleType() *OrderRoleUpdateOne {
	oruo.mutation.ClearRoleType()
	return oruo
}
...
func (oruo *OrderRoleUpdateOne) sqlSave(ctx context.Context) (_node *OrderRole, err error) {
	...
	if value, ok := oruo.mutation.StringRef(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: orderrole.FieldStringRef,
	...
	if oruo.mutation.StringRefCleared() {
		_spec.Fields.Clear = append(_spec.Fields.Clear, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Column: orderrole.FieldStringRef,
		})
	...
	if oruo.mutation.RoleTypeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderrole.RoleTypeTable,
	...
	if nodes := oruo.mutation.RoleTypeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   orderrole.RoleTypeTable,
