...
const (
	...
	// EdgeOrderPaymentPreference holds the string denoting the order_payment_preference edge name in mutations.
	EdgeOrderPaymentPreference = "order_payment_preference"
	...
	StatusItemColumn = "status_item_order_statuses"
	...
	// OrderPaymentPreferenceTable is the table the holds the order_payment_preference relation/edge.
	OrderPaymentPreferenceTable = "order_status"
	// OrderPaymentPreferenceInverseTable is the table name for the OrderPaymentPreference entity.
	// It exists in this package in order to avoid circular dependency with the "orderpaymentpreference" package.
	OrderPaymentPreferenceInverseTable = "order_payment_preferences"
	// OrderPaymentPreferenceColumn is the table column denoting the order_payment_preference relation/edge.
	OrderPaymentPreferenceColumn = "order_payment_preference_order_statuses"
)
...
var ForeignKeys = []string{
	...
	"order_payment_preference_order_statuses",
	"status_item_order_statuses",
}
