...
func (osc *OrderStatusCreate) SetStringRef(s string) *OrderStatusCreate {
	osc.mutation.SetStringRef(s)
	return osc
}

// SetNillableStringRef sets the "string_ref" field if the given value is not nil.
func (osc *OrderStatusCreate) SetNillableStringRef(s *string) *OrderStatusCreate {
	if s != nil {
		osc.SetStringRef(*s)
	}
	return osc
...
func (osc *OrderStatusCreate) SetStatusItemID(id int) *OrderStatusCreate {
	osc.mutation.SetStatusItemID(id)
	return osc
}

// SetNillableStatusItemID sets the "status_item" edge to the StatusItem entity by ID if the given value is not nil.
func (osc *OrderStatusCreate) SetNillableStatusItemID(id *int) *OrderStatusCreate {
	if id != nil {
		osc = osc.SetStatusItemID(*id)
	}
	return osc
}

// SetStatusItem sets the "status_item" edge to the StatusItem entity.
func (osc *OrderStatusCreate) SetStatusItem(s *StatusItem) *OrderStatusCreate {
	return osc.SetStatusItemID(s.ID)
}
...
func (osc *OrderStatusCreate) SetOrderPaymentPreferenceID(id int) *OrderStatusCreate {
	osc.mutation.SetOrderPaymentPreferenceID(id)
	return osc
}
...
func (osc *OrderStatusCreate) SetNillableOrderPaymentPreferenceID(id *int) *OrderStatusCreate {
	if id != nil {
		osc = osc.SetOrderPaymentPreferenceID(*id)
	}
	return osc
}

// SetOrderPaymentPreference sets the "order_payment_preference" edge to the OrderPaymentPreference entity.
func (osc *OrderStatusCreate) SetOrderPaymentPreference(o *OrderPaymentPreference) *OrderStatusCreate {
	return osc.SetOrderPaymentPreferenceID(o.ID)
}
...
func (osc *OrderStatusCreate) createSpec() (*OrderStatus, *sqlgraph.CreateSpec) {
	...
	if value, ok := osc.mutation.StringRef(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
	...
	if nodes := osc.mutation.StatusItemIDs(); len(nodes) > 0 {
		...
		_node.status_item_order_statuses = &nodes[0]
	...
	if nodes := osc.mutation.OrderPaymentPreferenceIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
		...
		_node.order_payment_preference_order_statuses = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
