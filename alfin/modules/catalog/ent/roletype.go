...
// was not loaded in eager-loading.
func (e RoleTypeEdges) OrderRolesOrErr() ([]*OrderRole, error) {
	if e.loadedTypes[2] {
...
// QueryOrderRoles queries the "order_roles" edge of the RoleType entity.
func (rt *RoleType) QueryOrderRoles() *OrderRoleQuery {
	return (&RoleTypeClient{config: rt.config}).QueryOrderRoles(rt)
}
