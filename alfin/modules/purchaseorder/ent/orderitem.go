...
func (e OrderItemEdges) ItemIssuancesOrErr() ([]*ItemIssuance, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e OrderItemEdges) OrderItemPriceInfosOrErr() ([]*OrderItemPriceInfo, error) {
	if e.loadedTypes[2] {
...
func (*OrderItem) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case orderitem.FieldID, orderitem.FieldOrderItemSeqID, orderitem.FieldExternalID, orderitem.FieldOrderItemTypeID, orderitem.FieldOrderItemGroupSeqID, orderitem.FieldFromInventoryItemID, orderitem.FieldBudgetID, orderitem.FieldBudgetItemSeqID, orderitem.FieldProductID, orderitem.FieldProductFeatureID, orderitem.FieldProdCatalogID, orderitem.FieldProductCategoryID, orderitem.FieldQuoteID, orderitem.FieldQuoteItemSeqID, orderitem.FieldShoppingListID, orderitem.FieldShoppingListItemSeqID, orderitem.FieldSubscriptionID, orderitem.FieldDeploymentID, orderitem.FieldRecurringFreqUomID, orderitem.FieldCorrespondingPoID, orderitem.FieldStatusID, orderitem.FieldSyncStatusID, orderitem.FieldOverrideGlAccountID, orderitem.FieldSalesOpportunityID:
			values[i] = new(sql.NullInt64)
		case orderitem.FieldIsItemGroupPrimary, orderitem.FieldSupplierProductID, orderitem.FieldIsPromo, orderitem.FieldIsModifiedPrice, orderitem.FieldItemDescription, orderitem.FieldComments, orderitem.FieldDontCancelSetUserLogin, orderitem.FieldChangeByUserLoginID:
...
// QueryItemIssuances queries the "item_issuances" edge of the OrderItem entity.
func (oi *OrderItem) QueryItemIssuances() *ItemIssuanceQuery {
	return (&OrderItemClient{config: oi.config}).QueryItemIssuances(oi)
}

// QueryOrderItemPriceInfos queries the "order_item_price_infos" edge of the OrderItem entity.
func (oi *OrderItem) QueryOrderItemPriceInfos() *OrderItemPriceInfoQuery {
	return (&OrderItemClient{config: oi.config}).QueryOrderItemPriceInfos(oi)
}
...
func (oi *OrderItem) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", oi.StatusID))
	builder.WriteString(", sync_status_id=")
	builder.WriteString(fmt.Sprintf("%v", oi.SyncStatusID))
