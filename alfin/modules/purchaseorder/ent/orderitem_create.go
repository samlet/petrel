...
func (oic *OrderItemCreate) SetStatusID(i int) *OrderItemCreate {
	oic.mutation.SetStatusID(i)
	return oic
}

// SetNillableStatusID sets the "status_id" field if the given value is not nil.
func (oic *OrderItemCreate) SetNillableStatusID(i *int) *OrderItemCreate {
	if i != nil {
		oic.SetStatusID(*i)
	}
	return oic
...
func (oic *OrderItemCreate) SetSyncStatusID(i int) *OrderItemCreate {
	oic.mutation.SetSyncStatusID(i)
	return oic
}

// SetNillableSyncStatusID sets the "sync_status_id" field if the given value is not nil.
func (oic *OrderItemCreate) SetNillableSyncStatusID(i *int) *OrderItemCreate {
	if i != nil {
		oic.SetSyncStatusID(*i)
	}
	return oic
}
...
func (oic *OrderItemCreate) AddItemIssuanceIDs(ids ...int) *OrderItemCreate {
	oic.mutation.AddItemIssuanceIDs(ids...)
	return oic
}

// AddItemIssuances adds the "item_issuances" edges to the ItemIssuance entity.
func (oic *OrderItemCreate) AddItemIssuances(i ...*ItemIssuance) *OrderItemCreate {
	ids := make([]int, len(i))
	for j := range i {
		ids[j] = i[j].ID
	}
	return oic.AddItemIssuanceIDs(ids...)
}

// AddOrderItemPriceInfoIDs adds the "order_item_price_infos" edge to the OrderItemPriceInfo entity by IDs.
func (oic *OrderItemCreate) AddOrderItemPriceInfoIDs(ids ...int) *OrderItemCreate {
	oic.mutation.AddOrderItemPriceInfoIDs(ids...)
	return oic
}

// AddOrderItemPriceInfos adds the "order_item_price_infos" edges to the OrderItemPriceInfo entity.
func (oic *OrderItemCreate) AddOrderItemPriceInfos(o ...*OrderItemPriceInfo) *OrderItemCreate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return oic.AddOrderItemPriceInfoIDs(ids...)
}
...
func (oic *OrderItemCreate) createSpec() (*OrderItem, *sqlgraph.CreateSpec) {
	...
	if value, ok := oic.mutation.StatusID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
	...
	if value, ok := oic.mutation.SyncStatusID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
	...
	if nodes := oic.mutation.ItemIssuancesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := oic.mutation.OrderItemPriceInfosIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
