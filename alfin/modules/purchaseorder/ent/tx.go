...
func (tx *Tx) init() {
	tx.ItemIssuance = NewItemIssuanceClient(tx.config)
	...
	tx.OrderItemPriceInfo = NewOrderItemPriceInfoClient(tx.config)
...
// applies a query, for example: ItemIssuance.QueryXXX(), the query will be executed
