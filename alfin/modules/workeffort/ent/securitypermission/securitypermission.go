...
const (
	// Label holds the string label denoting the securitypermission type in the database.
	Label = "security_permission"
	...
	// Table holds the table name of the securitypermission in the database.
	...
	SecurityGroupPermissionsColumn = "security_permission_security_group_permissions"
)

// Columns holds all SQL columns for securitypermission fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
