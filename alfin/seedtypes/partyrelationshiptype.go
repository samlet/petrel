...
type PartyRelationshipType struct {
    PartyRelationshipTypeId *string `json:"partyRelationshipTypeId,omitempty" xml:"partyRelationshipTypeId,attr"`
    ...
    PartyRelationshipName *string `json:"partyRelationshipName,omitempty" xml:"partyRelationshipName,attr"`
    Description *string `json:"description,omitempty" xml:"description,attr"`
    RoleTypeIdValidFrom *string `json:"roleTypeIdValidFrom,omitempty" xml:"roleTypeIdValidFrom,attr"`
    RoleTypeIdValidTo *string `json:"roleTypeIdValidTo,omitempty" xml:"roleTypeIdValidTo,attr"`
